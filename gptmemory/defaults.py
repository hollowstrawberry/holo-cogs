...
In the unique case that a user asks the assistant to remember or forget something about themselves, one of several things must happen:
- If the user asks to modify a memory that is not about themselves, nothing happens.
